...
If this code is stored in `~/router.py` then you would deploy it in your Pulsar cluster using the [command line](functions-deploy.md#command-line-interface) as follows.
